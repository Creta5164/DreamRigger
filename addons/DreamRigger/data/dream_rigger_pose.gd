...
signal changed_ext(sender: DreamRiggerPose)
...
func _on_sprites_changed() -> void:
    ...
    for uid in sprites:
        ...
        sprites[uid] = last_valid_sprite.duplicate_deep(Resource.DEEP_DUPLICATE_ALL)
        sprite_created = true
        pass
...
## Returns a [DreamRiggerSprite] at the specified UID.
## [br][br]
...
## [br][br]
## Warning : Dictionary is likely not intended to use ordered by default, use it with caution.
## [br]
## (See [url]https://github.com/godotengine/godot/issues/90142[/url])
