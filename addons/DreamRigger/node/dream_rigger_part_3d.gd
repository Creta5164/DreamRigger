## A [Node3D]-based rigging component that manages character parts through pose and sprite manipulation.
## 
...
## Emitted when the [member Sprite3D.flip_h] or [member Sprite3D.flip_v] property is modified.
...
## Resolved [member Sprite3D.flip_h] in part hierarchy.
...
## Resolved [member Sprite3D.flip_v] in part hierarchy.
...
static func find_parent_part(node: Node, find_root: bool = false, topmost_node: Node = null) -> DreamRiggerPart3D:
