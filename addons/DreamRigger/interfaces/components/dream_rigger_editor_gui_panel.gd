## The base class used to define each panel in the DreamRigger control panel.
## 
## Within the control panel, this makes display the name of each panel.
## [br][br]
## Also when [SplitContainer] is the parent, enable the ability to quickly expand
## or collapse the name section by double-clicking it.
@tool
class_name DreamRiggerEditorGUIPanel extends Control
